...
for i in range(200046, 200049):
    url = 'https://www.bilibili.com/video/BV1gB4y1771W/?spm_id_from=333.1007.tianma.1-1-1.click'
    print(url)
    urls.append(url)
            ...
            if cid_html_1 or cid_html_2:
                ...
                for video_each in video_selector:
                    ...
                    if jsDict['code'] == 0:
                        ...
                        try:
                            conn = connect(host='47.100.123.178', user='root', passwd='123456a!', port=3306, charset='utf8')
                            cur = conn.cursor()
                            conn.select_db('spider')
                            cur.execute('INSERT INTO bilibili_video VALUES (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)',
